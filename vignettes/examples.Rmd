...
Our analysis shows that the effect of motherhood on earnings inequality among women has decreased between 1980 and 2020. While pre-treatment, compositional, and between-group effect have not changed dramatically, changes in earnings following motherhood have brought women's earnings within each income group closer together in the last decade. The sq. coef. of var. has decreased by 2 points, which is about 50% of its original value.
